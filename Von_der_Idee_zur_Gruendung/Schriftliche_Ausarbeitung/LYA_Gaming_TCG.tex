...
\begin{figure}[htp]
	...
	\centering
	\includegraphics[width=.8\textwidth]{/home/user/Dokumente/Universität/Informatik_Master/Semester_X/Von_der_Idee_zur_Gruendung/Schriftliche_Ausarbeitung/Abbildungen/pie_chart_better_neu_better.png}
...
Da wir für die initialen 3000 Karten KI-Bilder benutzen werden, belaufen sich die Kosten dafür auf 25€/Monat für zwei Monate und da es nur zwei Monate sind werden sie in den Tortendiagrammen nicht aufgeführt.

\subsection{Anwaltskosten} \label{subsec:Anwaltskosten}

Es werden Anwaltskosten anfallen pro Land, in dem wir Geschäfte tätigen werden, in Höhe von 3000€, um die EULA (End User License Agreement) zu schreiben, und 3000€, um die AGB (Allgemein Geschäftsbedingungen) zu schreiben. Wir werden diese Kosten in Raten von 500€ für 12 Monate Zahlen.

\subsection{Fall 1: Ohne EXIST}
