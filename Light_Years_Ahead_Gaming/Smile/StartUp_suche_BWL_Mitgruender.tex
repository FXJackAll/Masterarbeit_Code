...
\begin{document}
	...
	Ich suche eine*n BWLer*in/Wirtschaftswissenschaftler*in/Wirtschaftsinformatiker*in als Co-Gründer*in für die Bewerben auf das EXIST-Gründerstipendium. Das Exist-Gründerstipendium unterstützt Gründer*innen dabei, ihr Projekt für ein Jahr zu entwickeln, finanziert mit 2.500€ pro Person/Monat (zzgl. Zuschläge), vorausgesetzt der/die Gründer*in hat mindestens einen Bachelorabschluss. Das EXIST-Gründerstipendium ist ein Vollstipendium und muss nicht zurückgezahlt werden.\hfill\newline
	
	\noindent Deine Aufgaben werden sein:
	
	\begin{itemize}
		
		\item Erstellen eines Businessplanes
		
		\item Marktforschung
		
		\item Gründungsmanagement
		
		\item Markteintrittstrategie
		
		\item Investorensuche
