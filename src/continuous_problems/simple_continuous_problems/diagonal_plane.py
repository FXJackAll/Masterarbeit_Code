...
class Diagonal_Plane(Problem):
    TYPE = 'simple_continuous_problem'
    """
    """

    def __init__(self, simple_con_pr_name: str,
                 problem_path="../problems/continuous_problems/simple_continuous_problems/",
    ...
    def get_solution_quality(self, solution: dict) -> (float, bool):
        ...
        function_value = 1/self._dimension * reduce(lambda x,y: x + y, continuous_variables)
