...
\begin{document}
	...
	\subsubsection{Metaheuristiken, die für stetige Probleme adaptiert wurden} \label{subsubsec:Grundlagen:Vergleichsalgorithmen:Meta_-_Heuristiken_stetige_Probleme}
		...
		\begin{lstlisting}[language=json, caption=Paraboloid 5 Dim gemischte Variablen, label=subsubsec:Testfunktionen:Konstruierte_Testfunktionen:JSON:Paraboloid5Dim11MV]
{
	...
	\begin{table}[H]
		...
		\caption{Vergleich zwischen ACO\(_{\mathbb{R}}\), \acl{acorvs}, Varianten von \acl{acorvsmv} und anderen Metaheuristiken, die für stetige Probleme adaptiert wurden, basierend auf \textit{Socha und Dorigo}~\cite{socha2008ant} und damit auf \textit{Kern et al., 2004}~\cite{kern2004learning}, Teil 1}
	...
	\begin{table}[H]
		...
		\caption{Vergleich zwischen ACO\(_{\mathbb{R}}\), \acl{acorvs}, Varianten von \acl{acorvsmv} mit Neustartstrategie \(fixed = 0\) (NSS-f0) und anderen Metaheuristiken, die für stetige Probleme adaptiert wurden, basierend auf \textit{Socha und Dorigo}~\cite{socha2008ant} und damit auf \textit{Kern et al., 2004}~\cite{kern2004learning}, Teil 2}
	...
	\begin{table}[H]
		...
		\caption{Vergleich zwischen ACO\(_{\mathbb{R}}\),\acl{acorvs}, Varianten von \acl{acorvsmv} mit Neustartstrategie \(adaptive\) (NSS-adapt) und anderen Metaheuristiken, die für stetige Probleme adaptiert wurden, basierend auf \textit{Socha und Dorigo}~\cite{socha2008ant} und damit auf \textit{Kern et al., 2004}~\cite{kern2004learning}, Teil 3}
