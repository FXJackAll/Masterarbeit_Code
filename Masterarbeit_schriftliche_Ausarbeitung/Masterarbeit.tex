...
\begin{document}
	...
	Als letztes fällt noch auf, dass \glqq UpdatePheromoneInformation\grqq{}, gegeben eine \(n \times n\)-Matrix, da jeder Matrixeintrag aktualisiert werden muss, \(\mathcal{O}(n^2)\) Schritte braucht, was bei großen Problemen viel Zeit verbraucht. Dies wurde durch \textit{Guntsch und Middendorf}~\cite{guntsch2002population}, mit der Weiterentwicklung der ACO-Metaheuristik zu der P-ACO-Metaheuristik, verbessert.
