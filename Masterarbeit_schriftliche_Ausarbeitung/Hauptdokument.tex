...
%------------------------------------------------------------------------------------------------ %
\title{Anwenden der Kombination aus dem ACO\(_\mathbb{R}\)-Very-Simple Algorithmus und dem HSPPBO-Sheme auf das Traveling Spice Salesperson Problem}  % Insert your thesis title
\author{Felix Cäsar Madorskiy} % insert your name
\date{\today}
...
\begin{document}
	...
	\include{Titlepage_MA.tex} % this file contains the title page
